...
<body>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('pickupman.product.table') }}">
                            <span class="menu-title" id="notification-count">Parcel Table</span>
    ...
    <!-- JavaScript code for updating notification count -->
    <script>
        // Function to update the notification count
        function updateNotificationCount() {
            // AJAX call to get the new parcel count
            $.ajax({
                url: 'get_new_parcel_count.php',
                type: 'GET',
