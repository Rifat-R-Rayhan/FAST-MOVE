    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h2 class="text-center mb-4">Become a Pickup Man</h2>

                        <!-- Form -->
                        <form action="{{route('pickupman.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row"> 
                                <div class="col-md-6">
                                <div class="mb-3">
                                <input type="text" class="form-control" name="pickupman_name" value="{{ old('pickupman_name') }}" placeholder="Pickupman Name">
                            ...
                            <div class="mb-3">
                                <input type="tel" class="form-control" name="alt_phone" value="{{ old('alt_phone') }}" placeholder="Alternative Phone Number">
                                @error('alt_phone')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="file" id="nid_front" name="nid_front">
                                @error('nid_front')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="file" id="nid_back" name="nid_back">
                                @error('nid_back')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
