        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#general-page" aria-expanded="false"
                            aria-controls="general-page">
                        ...
                        <div class="collapse" id="general-page">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{route('admin.daily_sales.report')}}"> Daily Parcels </a></li>
                                <li class="nav-item"> <a class="nav-link" 
                                    href="{{route('admin.return_sales.report')}}">Return Parcels </a></li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{route('admin.daily_total_sales.report')}}">
                                        Daily Total Parcel </a></li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{route('admin.merchant_sales.report')}}"> Merchant Parcels
                                    </a></li>
                                {{-- <li class="nav-item"> <a class="nav-link"
                                        href=""> 500
                                    </a></li> --}}
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#page" aria-expanded="false"
                            aria-controls="page">
                        ...
                        <div class="collapse" id="page">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" 
                                    href="{{route('admin.news')}}">News Create </a></li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{route('admin.news.table')}}"> News Table </a></li>
                            </ul>
                        </div>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#pagehubs" aria-expanded="false"
                            aria-controls="pagehubs">
                            <span class="menu-title">Hubs</span>
                            <i class="menu-arrow"></i>
                            <i class="mdi mdi-medical-bag menu-icon"></i>
                        </a>
                        <div class="collapse" id="pagehubs">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" 
                                    href="{{route('admin.hubs')}}">Hub Create </a></li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{route('admin.hubs.table')}}"> Hubs Table </a></li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.newsletter-subscribers') }}">
                    ...
                    {{-- <li class="nav-item">
                        ...
                        <div class="collapse" id="page">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" 
                                    href="{{route('admin.about.edit')}}">About Us </a></li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{route('admin.terms.edit')}}"> Terms and Conditions </a></li>
                                <li class="nav-item"> <a class="nav-link"
