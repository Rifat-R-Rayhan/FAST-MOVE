                            ...
                            @foreach ($products as $delivery)
                                <tr class="table-info">
                                    ...
                                    @elseif ($delivery->is_active == 3)
                                        <td><span class="badge bg-label-danger me-1 text-dark">Product arrived <br> in the
                                                <br>
                                                ware house</span></td>
                                    @elseif ($delivery->is_active == 4)
                                        <td><span class="badge bg-label-danger me-1 text-dark">Product picked <br> by
                                                delivery
                                                man</span></td>
                                    ...
                                    @elseif($delivery->is_active === '9')
                                        <td><span class="badge bg-label-success me-1 text-dark">pickupman accept <br> for
                                                return</span></td>
                                    @elseif($delivery->is_active === '10')
                                        <td><span class="badge bg-label-success me-1 text-dark">Product rerun <br>
                                    ...
                                    <td>
                                        <div class="d-flex justify-center align-items-center gap-2">
                                            ...
                                            @if ($delivery->is_active == 3)
                                                ...
                                                <form id="productcheckout" {{-- action="{{ route('admin.product.delivery_checkout') }}" method="post"> --}}
